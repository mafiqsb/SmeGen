    ...
    <div className="w-full py-[10rem] px-4 bg-white">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div className="relative w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          <span className="bg-red-500 w-[120px] text-center rounded-md font-medium text-white absolute top-[-10px] right-[-7px]">
            Reccomended
          </span>
          <img
            ...
            alt="/"
          />
          <h2 className="text-2xl font-bold text-center py-8">Sharing User</h2>
          <p className="text-center text-4xl font-bold">$149</p>
          <div className="text-center font-medium">
            <p className="py-2 border-b mx-8 mt-8">500 GB Storage</p>
            <p className="py-2 border-b mx-8">1 Granted User</p>
