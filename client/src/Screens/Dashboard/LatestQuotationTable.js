...
export default function LatestQuotationTable(props) {
  const { clientDetails } = props;

  return (
    <div className="flex flex-col rounded-md bg-white shadow-md border mb-4 md:w-full xl:h-[175px] lg:h-[230px] w-full">
      <div className="flex justify-between items-center md:p-4 border-b p-8">
        <h2 className="font-bold text-xl">Latest Quotation</h2>
        <button className="flex bg-amber-300 hover:bg-[#570987] hover:text-amber-300 duration-300 md:w-36 md:h-8 w-28 h-8 shadow-md rounded-md items-center justify-center text-xs">
